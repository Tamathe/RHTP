...
- Browser Realtime sessions now expose `getMetricsReport()` for speech-start to output-audio latency, p95/p99 rollups, tool-gateway samples, and budget booleans.

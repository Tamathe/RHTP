...
- Browser WebRTC attach is now covered separately in `docs/ops/red-team-results/2026-07-04-real-voice-browser-attach.md`.
- This does not complete P2 real voice exit. Transcript persistence, Sandy tool gateway, latency proof, and full voice-journey red-team proof remain pending.
